            ...
            @endif
                <div class="tab-content">
                    ...
                    <div class="tab-pane position-relative" id="step_2">
                        ...
                        <p class="mt-4">
                            <input type="text" id="nicknameInput" name="user_nickname"
                                class="form-control input_underline w-50" placeholder="請輸入暱稱" />
                        </p>
                        <div class="d-inline-flex align-items-baseline my-3">
                            <button id="checkNicknameButton"
                                class="btn btn-c2 mt-2 rounded-pill step-confirm">檢查暱稱是否重複</button>
                            ...
                            <div class="step-div ms-3">
                                <ul class="nav nav-pills align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <button id="step_3_btn" type="button" class="step-btn step-next-btn nav-link me-1" disabled
                    ...
                    <div class="tab-pane position-relative" id="step_6">
                        ...
                        <div class="my-3">
                            ...
                            <label class="btn btn-outline-gy1 rounded-pill px-3" for="user_unmarried">未婚</label>
                            <p class="mb-2"></p>
                            <input type="radio" class="btn-check" name="user_married_state" id="user_married"
                                value="已婚" autocomplete="off" />
                            <label class="btn btn-outline-gy1 rounded-pill px-3" for="user_married">已婚</label>
                        </div>
                        <div class="d-inline-flex align-items-baseline my-3">
                            <button class="btn btn-c2 rounded-pill step-confirm">寫下</button>
                            <div class="step-div ms-3">
                    ...
                    <div class="tab-pane position-relative" id="step_8">
                        ...
                        <p class="title" style="color: white">
                            <span class="ol" style="color: white">08.</span>
                        ...
                        <div class="my-3">
                            ...
                            <p class="mb-2"></p>
                            <input type="radio" class="btn-check" name="user_pregnant_state" id="p_item_6"
                                value="正經歷流產" autocomplete="off" />
                            <label class="btn btn-outline-gy1 rounded-pill px-3" for="p_item_6">正經歷流產</label>
                        </div>
                        <div class="d-inline-flex align-items-baseline my-3">
                            <button class="btn btn-c2 rounded-pill step-confirm">寫下</button>
                    ...
                    <div class="tab-pane position-relative" id="step_11">
                        ...
                        <div class="row my-3 align-items-end">
                            ...
                            <div class="col-auto">
                                ...
                                <p class="mb-2"></p>
                                <input type="checkbox" class="btn-check" name="user_disease_state" id="ds_item_15"
                                    value="子宮內膜異位" autocomplete="off" />
                                <label class="btn btn-outline-gy1 rounded-pill px-3" for="ds_item_15">子宮內膜異位</label>
                                <p class="mb-2"></p>
                                <div class="input-group">
                                    <input type="checkbox" class="btn-check" name="user_disease_state" id="ds_item_16"
                                        value="1" autocomplete="off" />
                                    <label class="btn btn-outline-gy1 rounded-pill px-3" for="ds_item_16">其他：</label>
                    ...
                    <div class="tab-pane position-relative" id="step_14">
                        ...
                        <form id="register_form" class="form_mail" action="UserRegister" method="POST">
                            @csrf

                            <input type="hidden" name="usermail" value={{ session('usermail') }}>
                            <input type="hidden" name="user_name" id='return_user_name'>
                            ...
                            <input type="hidden" name="other_disease" id='return_other_disease'>
                        ...
                        @section('email_content') 
                            <fieldset class="col-12">
                                ...
                                <span style="visibility:hidden;" onclick="register_step(this,3)"
                                    id="gender"></span>{{-- 性別 --}}
                                <span style="visibility:hidden;" onclick="register_step(this,13)" id="name"></span>
                        ...
                        <div class="row g-2 mt-2">
                            <!-- <div class="row g-2 mt-2" style="position: fixed; bottom: 0;left: 50%; transform: translateX(-50%); text-align: center; "> -->
                            <div class="col-12 my-2 justify-content-center d-flex">
                            ...
                            <div class="col-12 my-2 text-center">
                                <button type="submit" form="register_form" onclick="user_data()"
