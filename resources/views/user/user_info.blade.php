                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-12 col-lg-6" style="font-size: var(--fs-18)">
                            ...
                            <div class="row g-3 mb-2 align-items-center">
                                ...
                                <div class="col">
                                    <select class="form-select" id="pregnant_state" name='pregnant_state'>
                                        <option value="未懷孕/產後" {{ $expecting == '未懷孕/產後' ? 'selected' : '' }}>未懷孕/產後，已停止哺乳
                                        </option>
                            ...
                            <div class="row g-3 mb-2 align-items-center">
                                ...
                                <div class="col-auto mx-1 form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="user_allergy"
                                        id="user_allergy_1" value="有" {{ $user_allergy != null ? 'checked' : '' }}>
                                    <label class="form-check-label" for="user_allergy_1">有</label>
                                </div>
                                <div class="col-auto mx-1 form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="user_allergy"
                                        id="user_allergy_0" value="無" {{ $user_allergy == null ? 'checked' : '' }}>
                            ...
                            <div class="row g-3 mb-2 align-items-center">
                                ...
                                <div class="col">
                                    <select class="form-select" id="married_state" name='married_state'>
                                        <option value="unmarried" {{ $marriage == false ? 'selected' : '' }}>未婚</option>
