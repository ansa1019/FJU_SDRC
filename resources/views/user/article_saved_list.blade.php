        ...
        <div class="row pt-3 px-md-5">
            <div class="col-12 my-2">
                ...
                <div class="row d-flex align-items-center">
                    ...
                    {{-- <!--重新命名分類名稱-->
                    <button type="button" id="rename_saved_btn" class="btn btn-sm ct-sub-1 col-auto"
                        style="font-size: var(--fs-18)"><i class="fas fa-pen"></i></button>
                    <!--刪除分類-->
                    <button type="button" id="del_saved_btn" class="btn btn-sm ct-sub-1 col-auto"
                        style="font-size: var(--fs-18)"><i class="fas fa-trash"></i></button> --}}
                </div>
            </div>
        </div>
