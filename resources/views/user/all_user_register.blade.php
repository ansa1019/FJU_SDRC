            ...
            <div class="col-md col-lg-10 px-3">
                <div class="tab-content">
                    ...
                    <div class="tab-pane position-relative" id="step_3">
                        ...
                        <div class="step-div">
                            <ul class="nav nav-pills align-items-center">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="step-btn step-next-btn nav-link me-1" disabled disabled
                                        data-bs-toggle="pill" data-bs-target="#step_3_fin" onclick="register_step(this)">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                </li>
                                註冊進度：3/14
                    ...
                    <div class="tab-pane position-relative" id="step_3_fin">
                        ...
                        <button class="btn btn-c2 mt-4 rounded-pill step-confirm">確定</button>
                    ...
                    <div class="tab-pane position-relative" id="step_4">
                        ...
                        <div class="step-div">
                            <ul class="nav nav-pills align-items-center">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="step-btn step-next-btn nav-link me-1" disabled disabled
                                        data-bs-toggle="pill" data-bs-target="#step_5" onclick="register_step(this)">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                </li>
                                註冊進度：4/14
                    ...
                    <div class="tab-pane position-relative" id="step_5">
                        ...
                        <div class="step-div">
                            <ul class="nav nav-pills align-items-center">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="step-btn step-next-btn nav-link me-1" disabled disabled
                                        data-bs-toggle="pill" data-bs-target="#step_6" onclick="register_step(this)">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                </li>
                                註冊進度：5/14
                    ...
                    <div class="tab-pane position-relative" id="step_8">
                        ...
                        <div class="step-div" style="color: white">
                            <ul class="nav nav-pills align-items-center">
                                <li class="nav-item">
                                    <button type="button" class="step-btn nav-link me-1" data-bs-toggle="pill"
                    ...
                    <div class="tab-pane position-relative" id="step_9">
                        ...
                        <div class="step-div">
                            <ul class="nav nav-pills align-items-center">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="step-btn step-next-btn nav-link me-1" disabled
                                        data-bs-toggle="pill" data-bs-target="#step_10" onclick="register_step(this)">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                </li>
                                註冊進度：9/14
                    ...
                    <div class="tab-pane position-relative" id="step_10">
                        ...
                        <div class="step-div">
                            <ul class="nav nav-pills align-items-center">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="step-btn step-next-btn nav-link me-1" disabled
                                        data-bs-toggle="pill" data-bs-target="#step_11" onclick="register_step(this)">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                </li>
                                註冊進度：10/14
                    ...
                    <div class="tab-pane position-relative" id="step_11">
                        ...
                        <div class="my-3">
                            ...
                            <div class="input-group w-50">
                                ...
                                <input type="text" class="form-control input_underline ms-2" name="user_disease_state"
                                    id="ds_item_other" placeholder="請填入病症" />
                            </div>
                        </div>
                        <button class="btn btn-c2 mt-4 rounded-pill step-confirm">寫下</button>
                        ...
                        <div class="step-div">
                            <ul class="nav nav-pills align-items-center">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="step-btn step-next-btn nav-link me-1" disabled
                                        data-bs-toggle="pill" data-bs-target="#step_12" onclick="register_step(this)">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                </li>
                                註冊進度：11/14
                    ...
                    <div class="tab-pane position-relative" id="step_12">
                        ...
                        <div class="step-div">
                            <ul class="nav nav-pills align-items-center">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="step-btn step-next-btn nav-link me-1" disabled
                                        data-bs-toggle="pill" data-bs-target="#step_13" onclick="register_step(this)">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                </li>
                                註冊進度：12/14
                    ...
                    <div class="tab-pane position-relative" id="step_13">
                        ...
                        <div class="step-div">
                            <ul class="nav nav-pills align-items-center">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="step-btn step-next-btn nav-link me-1" disabled
                                        data-bs-toggle="pill" data-bs-target="#step_14" onclick="register_step(this)">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                </li>
                                註冊進度：13/14
                    ...
                    <div class="tab-pane position-relative" id="step_14">
                        ...
                        <form method="POST" class="form_mail" action="/UserRegister">
                            @csrf
                            <fieldset>
                                <p>
                                    親愛的
                                    <span class="step-tabs" onclick="register_step(this,2)" id="nickname2"
                                        name="nickname"></span>
                                    ：
                                </p>
                                <p>
                                ...
                                <div class="row g-2 mt-2">
                                    ...
                                    <div class="col-12 my-1 text-center">
                                        <button type="submit" class="btn btn-c2 rounded-pill step-confirm">確認寄信</button>
                                    </div>
                                </div>
                        </form>
